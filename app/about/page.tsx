      ...
      return(
         <div className='flex min-h-screen flex-col items-center justify-between px-8 lg:px-28 font-sans text-black'>
          <section className='w-full my-4'>
            <h1 className='text-lg uppercase my-2'>{t('about our world')}</h1>
          ...
          {/* HOW TO PLAY */}
          <section className='w-full my-4'>
              <h2 className='text-lg uppercase'>{t('how to play')}</h2>
                  <div className='flex justify-start items-center my-2'>
                      <Image width={20} height={20} className='mr-2' src='/images/logo_64_64.png' alt='custom bullet point'/>
          ...
          {/* MEET THE TEAM */}
          <section className='w-full my-4'>
              <h2 className='text-lg uppercase'>{t('about the team')}</h2>
              <div className='flex justify-start items-center my-2'>
          ...
          {/* SOMETHING ELSE */}
          <section className='w-full my-4'>
              <h2 className='text-lg uppercase'>{t('something else')}</h2>
