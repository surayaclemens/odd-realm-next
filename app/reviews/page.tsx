                ...
                <h3 className='text-5xl my-2 lg:text-7xl text-center'>{t('reviews title')}</h3>
                    <div className='flex flex-col my-4'>
                        ...
                        <div className='flex flex-col lg:flex-row justify-between'>
                            <div className='flex flex-col items-end lg:my-16 bg-white bg-opacity-20 rounded-md p-4 lg:p-8'>
                            ...
                            <div className='flex flex-col items-end my-4 lg:my-16 bg-white bg-opacity-20 rounded-md p-4 lg:p-8'>
                                ...
                                <button className='hover:text-green-light hover:border-green-light bg-white bg-opacity-20 text-white border-2 border-white rounded-md py-2 px-3 text-md lg:text-xl lg:w-56'><a href='https://www.pcgamer.com/fantasy-colony-sim-odd-realm-is-quite-charming-and-a-bit-weird/' target='_blank'>{t('Read the full article')}</a></button> 
                            </div>
                        </div>
