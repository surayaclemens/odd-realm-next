          ...
          <div className='flex min-h-screen flex-col px-8 lg:px-32 xl:px-56 py-8 lg:py-52 font-sans text-white text-center'>
            ...
            <div className='flex flex-col justify-between items-center w-full'>
                <form className='flex flex-col w-full my-4 lg:w-2/3 xl:w-1/2' onSubmit={handleSubmit}>
                    <input className='my-2 text-md lg:text-xl bg-white bg-opacity-5 placeholder-placeholder border-2 text-white border-white rounded-md p-2 focus:outline-green-light' 
                        type='text' 
                    ...
                    <div className='flex items-center justify-between w-full'>
                        <input className='w-full my-2 text-md lg:text-xl bg-white bg-opacity-5 placeholder-placeholder border-2 text-white border-white rounded-md p-2 focus:outline-green-light' 
                            type='text' 
                        ...
                        />
                        <Image width={48} height={48} className='ml-2 rounded-md border-white hover:border-green-light border-2' src='/icons/star-white.svg' alt='magic star icon' title="Hate this part? We'll make one up for you :~)" onClick={() => handleSubject()}/>
                    </div>
                    {/* message box */}
                    <textarea className='my-2 text-md bg-white bg-opacity-5 placeholder-placeholder border-2 text-white border-white rounded-md p-2 lg:text-xl h-[200px] focus:outline-green-light' 
