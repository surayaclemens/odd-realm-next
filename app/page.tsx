    ...
    <main className="flex min-h-screen flex-col items-center justify-between px-8 lg:px-24 font-sans text-black">
        ...
        <section className='flex w-full flex-col justify-between lg:flex-row lg:items-center my-8'>
            <div className='flex flex-col'>
                <h1 className='text-5xl lg:text-8xl'>{t('tagline1')}</h1>
                <h1 className='text-5xl lg:text-8xl'>{t('tagline2')}</h1>
                <h1 className='text-5xl lg:text-8xl'>{t('tagline3')}</h1>
            </div>
        ...
        <section className='my-8 flex flex-col'>
            <h1 className='text-lg uppercase lg:text-2xl'>{t('about the game')}</h1>
            {/* DETAILS 1 */}
            ...
            <Link className='w-full flex justify-center my-8' href="/about">
                <button className='hover:text-white hover:border-white text-xl bg-white bg-opacity-20 text-black border-2 border-black rounded-md py-2 px-3'>{t('more')}</button>
            </Link>
            </div>
        </section>
