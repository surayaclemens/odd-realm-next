  ...
  return (
    ...
    <div className='flex flex-col justify-evenly'>
      ...
      <section className='my-8 lg:my-16 w-full flex flex-col justify-center items-center'>
        ...
        <div className=' w-full lg:w-[1000px] p-8 flex justify-center items-center z-0'>
          <Image className='w-full lg:w-[1000px] rounded-lg' src="/images/gifs/green_gif.gif" alt="gameplay farming gif" width={100} height={100} />
        </div>
      </section>
      ...
      <section className='my-8 lg:my-16 w-full flex flex-col justify-center items-center'>
        ...
        <div className=' w-full lg:w-[1000px] p-8 flex justify-center items-center z-0'>
          <Image className='w-full lg:w-[1000px] rounded-lg' src="/images/gifs/grey_gif.gif" alt="gameplay farming gif" width={100} height={100} />
        </div>
      </section>
      ...
      <section className='my-8 lg:my-16 w-full flex flex-col items-center justify-center'>
        ...
        <div className=' w-full lg:w-[1000px] p-8 flex justify-center items-center z-0'>
          <Image className='w-full lg:w-[1000px] rounded-lg' src="/images/gifs/pink_gif.gif" alt="gameplay farming gif" width={100} height={100} />
        </div>
        <Link className='hover:text-green-light hover:border-green-light text-xl bg-white bg-opacity-20 text-white border-2 border-white rounded-lg my-8 lg:my-20 py-2 px-3 text-center lg:w-[350px]' href="/about">{t('Learn more')}</Link>
      </section>
    </div>
    ...
    <br></br>
      ...
      {/* <section className='my-8 w-full flex flex-col items-center justify-center'>
          ...
          <input className='w-full lg:w-[350px] my-4 text-md bg-white bg-opacity-20 placeholder-placeholder border-2 text-white border-white focus:outline-green-light rounded-lg p-2' type='email' placeholder={t('youremail@address.com')} onChange={(e) => setUserEmail(e.target.value)} />
          <button className='hover:text-green-light hover:border-green-light bg-white bg-opacity-20 text-white border-2 border-white rounded-lg py-2 px-3 lg:w-[350px] text-xl'onClick={()=>handleNewsletter()} >{t('sign up')}</button>  
      </section> */}
    </main>
  )
}
