  ...
  return (
    ...
    <div className='flex flex-col justify-evenly'>
      ...
      <section className='my-8 lg:my-16 w-full flex flex-col justify-center items-center'>
        ...
        <div className='bg-midnight w-full lg:w-[1000px] p-8 flex justify-center items-center z-0 rounded-md'>
      ...
      <section className='my-8 lg:my-16 w-full flex flex-col items-center justify-center'>
        ...
        <Link className='hover:text-green-light hover:border-green-light text-xl bg-white bg-opacity-20 text-white border-2 border-white rounded-md my-8 lg:my-20 py-2 px-3 text-center lg:w-[350px]' href="/about">{t('Learn more')}</Link>
      </section>
    </div>
