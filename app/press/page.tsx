    ...
    const handleDownload = () => {
      ...
      return(
          <div className='flex min-h-screen flex-col px-8 lg:px-28 xl:px-56 py-8 lg:py-52 font-sans text-white'>
            ...
            <a className='hover:text-green hover:border-green text-xl bg-white bg-opacity-20 text-white border-2 border-white rounded-md py-2 px-3 text-center lg:w-[200px]' href='/press-kit.zip' target="_blank" rel="noopener noreferrer">{t('download')}</a>
          </div>
      );
  }
