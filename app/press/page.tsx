...
function PressPage () {
    ...
    const handleDownload = () => {
      ...
      return(
          <div className='flex min-h-screen flex-col px-8 lg:px-28 xl:px-56 py-8 lg:py-36 font-sans text-white'>
            <h3 className='text-5xl my-2 lg:text-7xl text-center'>{t('press kit')}</h3>
